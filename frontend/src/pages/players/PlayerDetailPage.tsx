...
export const PlayerDetailPage = () => {
  ...
  return (
    <div>
      ...
      {/* Player Stats */}
      <div className='grid grid-cols-1 lg:grid-cols-[25fr_75fr] gap-10 mt-5' id='player-stats'>
        ...
        {isLoadingStats ? (
          ...
          !stats ? (
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10 pb-10 lg:pb-10'>
